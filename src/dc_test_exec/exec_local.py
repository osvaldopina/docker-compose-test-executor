...
def main():
    path = abspath('/home/osvaldo/projects/app/integration-tests/test_config/compare_otel_grpc/splunk_pointertrace.yml')
    ...
    test_container = TestContainer(path, env, None, False, print)
