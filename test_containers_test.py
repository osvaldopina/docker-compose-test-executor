...
class TestX(unittest.TestCase):
    ...
    def testX(self):
        ...
        b = os.path.join(os.getcwd(), 'httpservervolume')
        print(b)
...
#         containers = [
# container for container in containers if container.name ==
# 'teste_container']
...
#         print(e)
#         print(f)
        # self.assertEquals(1, len(containersSub))
